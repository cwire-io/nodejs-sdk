...
exports.createRouteController = exports.createErrorResponse = exports.createErrorResponseBody = void 0;
var errorCodes_1 = require("../../constants/errorCodes");
function createErrorResponseBody(errorCode, body) {
    if (body === void 0) { body = {}; }
    return __assign({ status: errorCode, msg: errorCodes_1.errorCodes[errorCode], error: true }, body);
}
