            ...
            if (typeof query.where[key] === "object") {
                ...
                if (query.where[key].$like &&
                    ...
                    sequelizeQuery.where[key] = {
                        [sequelize_1.Op.like]: query.where[key].$like,
                    };
                }
                // String
                if (query.where[key].$notLike &&
                    ...
                    sequelizeQuery.where[key] = {
                        [sequelize_1.Op.notLike]: query.where[key].$notLike,
                    };
                }
                // String
                if (query.where[key].$iLike &&
                    ...
                    sequelizeQuery.where[key] = {
                        [sequelize_1.Op.iLike]: query.where[key].$iLike,
                    };
                }
                // String
                if (query.where[key].$regex &&
                    ...
                    sequelizeQuery.where[key] = {
                        [sequelize_1.Op.regexp]: query.where[key].$regex,
                    };
                }
                // String
                ...
                if ((query.where[key].$notEqual &&
                    ...
                    sequelizeQuery.where[key] = {
                        [sequelize_1.Op.ne]: query.where[key].$notEqual,
                    };
                }
                // String | Number
                if (query.where[key].$equal &&
                    ...
                    sequelizeQuery.where[key] = {
                        [sequelize_1.Op.eq]: query.where[key].$equal,
                    };
                }
                // (String | Number)[]
                if (query.where[key].$or && Array.isArray(query.where[key].$or)) {
                    sequelizeQuery.where[key] = {
                        [sequelize_1.Op.or]: query.where[key].$or,
                    };
                }
                ...
                if (query.where[key].$between &&
                    ...
                    sequelizeQuery.where[key] = {
                        [sequelize_1.Op.between]: query.where[key].$between,
                    };
                }
                // Number[] Sequelize only
                if (query.where[key].$notBetween &&
                    ...
                    sequelizeQuery.where[key] = {
                        [sequelize_1.Op.notBetween]: query.where[key].$notBetween,
                    };
                }
                // Number
                if (query.where[key].$lower &&
                    ...
                    sequelizeQuery.where[key] = {
                        [sequelize_1.Op.lt]: query.where[key].$lower,
                    };
                }
                // Number
                if (query.where[key].$lowerOrEqual &&
                    ...
                    sequelizeQuery.where[key] = {
                        [sequelize_1.Op.lte]: query.where[key].$lowerOrEqual,
                    };
                }
                // Number
                if (query.where[key].$higher &&
                    ...
                    sequelizeQuery.where[key] = {
                        [sequelize_1.Op.gt]: query.where[key].$higher,
                    };
                }
                // Number
                if (query.where[key].$higherOrEqual &&
                    ...
                    sequelizeQuery.where[key] = {
                        [sequelize_1.Op.gte]: query.where[key].$higherOrEqual,
                    };
                }
                // (Number | String)[]
                if (query.where[key].$in && Array.isArray(query.where[key].$in)) {
                    sequelizeQuery.where[key] = {
                        [sequelize_1.Op.in]: query.where[key].$in,
                    };
                }
                // (Number | String)[]
                if (query.where[key].$notIn && Array.isArray(query.where[key].$notIn)) {
                    sequelizeQuery.where[key] = {
                        [sequelize_1.Op.notIn]: query.where[key].$notIn,
                    };
                }
                // Number | String | Null
                if (query.where[key].$is &&
                    ...
                    sequelizeQuery.where[key] = {
                        [sequelize_1.Op.is]: query.where[key].$is,
                    };
                }
            }
        }
