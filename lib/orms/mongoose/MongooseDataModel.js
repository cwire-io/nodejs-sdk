...
class MongooseDataModel extends DataModel_1.DataModel {
    ...
    count(cwire, query) {
        return __awaiter(this, void 0, void 0, function* () {
            if (query && query.group) {
                return this.model
                    .aggregate()
                    .match(query_1.parseWhereQuery(query === null || query === void 0 ? void 0 : query.where))
                    .group(query.group)
                    .exec();
            }
            return this.model.count(query_1.parseWhereQuery((query === null || query === void 0 ? void 0 : query.where) || {}));
        });
    }
    findAll(cwire, query) {
        return __awaiter(this, void 0, void 0, function* () {
            let mongooseQuery = this.model.find(query_1.parseWhereQuery(query === null || query === void 0 ? void 0 : query.where));
    ...
    findOne(cwire, query) {
        return __awaiter(this, void 0, void 0, function* () {
            let mongooseQuery = this.model.findOne(query_1.parseWhereQuery(query === null || query === void 0 ? void 0 : query.where));
            if (query.limit && typeof query.limit === 'number') {
                mongooseQuery = mongooseQuery.limit(query.limit);
            }
            if (query.offset && typeof query.offset === 'number') {
    ...
    remove(cwire, query) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.model.remove(query_1.parseWhereQuery(query === null || query === void 0 ? void 0 : query.where)).exec();
        });
    }
    update(cwire, query, changes) {
        return __awaiter(this, void 0, void 0, function* () {
            const entity = yield this.model
                .update(query_1.parseWhereQuery(query === null || query === void 0 ? void 0 : query.where), changes)
                .exec();
            return entity_1.buildMongooseEntitiesResponse(this.getFieldsList(), [entity]);
        });
    }
