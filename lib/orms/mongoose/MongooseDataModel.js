...
class MongooseDataModel extends DataModel_1.DataModel {
                ...
                return __awaiter(this, void 0, void 0, function* () {
                    try {
                        if (this.isNew) {
                            ...
                            CWire_1.CWire.getInstance().getLogger().system(logger_2.DATA_MODEL_ENTITY_CREATED_EVENT_LOGGER_PREFIX, `Log creating of ${dataModel.getName()} entity ${this._id}`);
                            return;
                        }
                        yield CWire_1.CWire.getInstance()
                            .getAPI()
                        ...
                        CWire_1.CWire.getInstance()
                            .getLogger()
                            .error(this.isNew
                            ? logger_2.DATA_MODEL_ENTITY_CREATED_EVENT_LOGGER_PREFIX
                            : logger_2.DATA_MODEL_ENTITY_UPDATED_EVENT_LOGGER_PREFIX, `Error by logging ${error.toString()}`);
                    }
                });
            });
        }
    ...
    create(cwire, values) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return response_1.buildMongooseEntitiesResponse(this.getFieldsList(), [entity]);
        });
    }
    count(cwire, query) {
        return __awaiter(this, void 0, void 0, function* () {
            if (query && query.group) {
                return this.model
                    .aggregate()
                    .match(query_1.parseDataModelQueryToMongooseQuery(query))
                    .group(query.group)
                    .exec();
            }
            return this.model.count(query_1.parseDataModelQueryToMongooseQuery(query || {}));
        });
    }
    findAll(cwire, query) {
        return __awaiter(this, void 0, void 0, function* () {
            let mongooseQuery = this.model.find(query_1.parseDataModelQueryToMongooseQuery(query));
            ...
            return response_1.buildMongooseEntitiesResponse(this.getFieldsList(), entities);
        });
    }
    findOne(cwire, query) {
        return __awaiter(this, void 0, void 0, function* () {
            let mongooseQuery = this.model.findOne(query_1.parseDataModelQueryToMongooseQuery(query));
            if (query.limit && typeof query.limit === 'number') {
                mongooseQuery = mongooseQuery.limit(query.limit);
            }
            if (query.offset && typeof query.offset === 'number') {
    ...
    remove(cwire, query) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.model.remove(query_1.parseDataModelQueryToMongooseQuery(query)).exec();
        });
    }
    update(cwire, query, changes) {
        return __awaiter(this, void 0, void 0, function* () {
            const entity = yield this.model
                .update(query_1.parseDataModelQueryToMongooseQuery(query), changes)
                .exec();
            return response_1.buildMongooseEntitiesResponse(this.getFieldsList(), [entity]);
        });
    }
