...
class SequelizeDataModel extends DataModel_1.DataModel {
    ...
    count(cwire, query) {
        return __awaiter(this, void 0, void 0, function* () {
            const numberOfEntities = this.model.count(query_1.parseQueryToSequelize(query));
    ...
    findAll(cwire, query) {
        return __awaiter(this, void 0, void 0, function* () {
            const entities = yield this.model.findAll(query_1.parseQueryToSequelize(query));
    ...
    findOne(cwire, query) {
        return __awaiter(this, void 0, void 0, function* () {
            const parsedQuery = query_1.parseQueryToSequelize(query);
    ...
    remove(cwire, query) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.model.destroy(query_1.parseQueryToSequelize(query));
        });
    }
    update(cwire, query, changes) {
        return __awaiter(this, void 0, void 0, function* () {
            const entity = yield this.model.findOne(query_1.parseQueryToSequelize(query));
            if (!entity) {
                return null;
            }
