    ...
    for (const key of Object.keys(query)) {
        ...
        if (typeof query[key] === 'object') {
            ...
            if (operations.$lower && typeof operations.$lower === 'number') {
                whereQuery = Object.assign(Object.assign({}, whereQuery), { [sequelize_1.Op.lt]: operations.$lower });
            }
            if (operations.$lowerOrEqual &&
                typeof operations.$lowerOrEqual === 'number') {
                whereQuery = Object.assign(Object.assign({}, whereQuery), { [sequelize_1.Op.lte]: operations.$lowerOrEqual });
            }
            if (operations.$higher && typeof operations.$higher === 'number') {
                whereQuery = Object.assign(Object.assign({}, whereQuery), { [sequelize_1.Op.gt]: operations.$higher });
            }
            if (operations.$higherOrEqual &&
                typeof operations.$higherOrEqual === 'number') {
                whereQuery = Object.assign(Object.assign({}, whereQuery), { [sequelize_1.Op.gte]: operations.$higherOrEqual });
            }
...
function parseQueryToSequelize(query) {
