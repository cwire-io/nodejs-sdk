            ...
            try {
                switch (dataModel.getType()) {
                    case 'Sequelize': {
                        ...
                        this.cwire
                            .getLogger()
                            .system(COUNT_ENTITY_LOGGER_PREFIX, `Count entities by sequelize: ${JSON.stringify(numberOfEntities)}`);
                        return {
                            success: true,
                    ...
                    case 'Mongoose': {
                        if (query && query.group) {
                            ...
                            this.cwire
                                .getLogger()
                                .system(COUNT_ENTITY_LOGGER_PREFIX, `Count entities by mongoose: ${JSON.stringify(counts)}`);
                            return {
                                success: true,
                                data: counts,
                            };
                            ...
                            this.cwire
                                .getLogger()
                                .system(COUNT_ENTITY_LOGGER_PREFIX, `Created new entity: ${JSON.stringify(numberOfEntities)}`);
                            return {
                                success: true,
                                data: numberOfEntities || 0,
                            };
