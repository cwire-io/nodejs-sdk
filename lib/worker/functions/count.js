...
var Count = /** @class */ (function (_super) {
    ...
    Count.prototype.controller = function (modelName, query) {
        return __awaiter(this, void 0, void 0, function () {
            var dataModel, _a, numberOfEntities, counts, numberOfEntities;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        numberOfEntities = _b.sent();
                        return [2 /*return*/, {
                                success: true,
                                data: numberOfEntities || 0,
                            }];
                    case 3:
                        if (!query.group) return [3 /*break*/, 5];
                        return [4 /*yield*/, dataModel
                                .getMongooseModel()
                                .aggregate()
                    ...
                    case 5: return [4 /*yield*/, dataModel
                            .getMongooseModel()
                            .count(sequelize_1.parseDataModelQueryToSequelizeQuery(query))];
                    case 6:
                        numberOfEntities = _b.sent();
    ...
    Count.prototype.getName = function () {
        return "DATA_MODEL::COUNT";
    };
    Count.prototype.getParameters = function () {
        return [
            {
                type: "option",
                isRequired: true,
