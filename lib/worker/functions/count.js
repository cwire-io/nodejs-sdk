    ...
    controller(modelName, query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.cwire
                    .getLogger()
                    .system(logger_1.COUNT_ENTITY_LOGGER_PREFIX, `Count all ${modelName} entities with ${JSON.stringify(query)}.`);
                return { success: true, data: yield dataModel.count(this.cwire, query) };
            }
            catch (err) {
                this.cwire
                    .getLogger()
                    .error(logger_1.COUNT_ENTITY_LOGGER_PREFIX, `Error on entity creation: ${err.toString()}`);
            }
