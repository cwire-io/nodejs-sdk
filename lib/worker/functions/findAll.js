    ...
    controller(modelName, query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.cwire
                    .getLogger()
                    .system(logger_1.FIND_ALL_ENTITY_LOGGER_PREFIX, `Find all ${dataModel} entities: ${entities}`);
                return {
                    success: true,
                    data: entities,
                };
                ...
                this.cwire
                    .getLogger()
                    .error(logger_1.FIND_ALL_ENTITY_LOGGER_PREFIX, `Error on entity creation: ${err.toString()}`);
            }
