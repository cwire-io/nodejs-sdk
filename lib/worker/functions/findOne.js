...
var FindOne = /** @class */ (function (_super) {
    ...
    FindOne.prototype.controller = function (modelName, query) {
        return __awaiter(this, void 0, void 0, function () {
            var dataModel, primaryKey, _a, entity, mongooseQuery, entity;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        dataModel = this.cwire.getDataModelByName(modelName);
                        primaryKey = dataModel.getPrimaryKey();
                        _a = dataModel.getType();
                        switch (_a) {
                            case "Sequelize": return [3 /*break*/, 1];
                            case "Mongoose": return [3 /*break*/, 3];
                            case "Custom": return [3 /*break*/, 5];
                        }
                        return [3 /*break*/, 6];
                    case 1: return [4 /*yield*/, dataModel
                            .getSequelizeModel()
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, mongooseQuery.exec()];
                    case 4:
                        entity = _b.sent();
                        return [2 /*return*/, {
                                success: true,
                    ...
                    case 6: return [2 /*return*/, { success: true, data: null }];
                }
            });
        });
    };
