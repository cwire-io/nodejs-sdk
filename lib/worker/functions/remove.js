...
var Remove = /** @class */ (function (_super) {
    ...
    Remove.prototype.controller = function (modelName, query) {
        return __awaiter(this, void 0, void 0, function () {
            var dataModel, primaryKey, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3: return [4 /*yield*/, dataModel
                            .getMongooseModel()
    ...
    Remove.prototype.getName = function () {
        return "DATA_MODEL::REMOVE";
    };
    Remove.prototype.getParameters = function () {
        return [
            {
                type: "option",
