    ...
    controller(modelName, query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.cwire
                    .getLogger()
                    .system(logger_1.REMOVE_ENTITIES_LOGGER_PREFIX, `Remove ${dataModel} entities ${JSON.stringify(result)}`);
                return { success: true, data: result };
            }
            catch (error) {
                this.cwire
                    .getLogger()
                    .error(logger_1.REMOVE_ENTITIES_LOGGER_PREFIX, `Error on entity creation: ${error.toString()}`);
            }
