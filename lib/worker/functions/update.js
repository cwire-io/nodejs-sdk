...
var Update = /** @class */ (function (_super) {
    ...
    Update.prototype.controller = function (modelName, id, values) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1: return [4 /*yield*/, dataModel
                            .getSequelizeModel()
                            .findOne({ where: (_b = {}, _b[primaryKey] = id, _b) })];
                    case 2:
                        entity = _c.sent();
                        if (!entity) {
                            return [2 /*return*/, { success: false }];
                        }
                        return [4 /*yield*/, entity.update(values)];
                    case 3:
                        _c.sent();
                        return [2 /*return*/, {
                                success: true,
    ...
    Update.prototype.getName = function () {
        return "DATA_MODEL::UPDATE";
    };
    Update.prototype.getParameters = function () {
        return [
            {
                type: "option",
