    ...
    controller(modelName, query, values) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.cwire
                    .getLogger()
                    .system(logger_1.UPDATE_ENTITIES_LOGGER_PREFIX, `Update ${dataModel} entities ${JSON.stringify(entities)}`);
                return { success: true, data: entities };
            }
            catch (error) {
                this.cwire
                    .getLogger()
                    .error(logger_1.UPDATE_ENTITIES_LOGGER_PREFIX, `Error on entity creation: ${error.toString()}`);
            }
