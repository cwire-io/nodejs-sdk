...
var Update = /** @class */ (function (_super) {
    ...
    Update.prototype.controller = function (modelName, query, values) {
        return __awaiter(this, void 0, void 0, function () {
            var dataModel, _a, entity, entity;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4: return [4 /*yield*/, dataModel
                            .getMongooseModel()
                    ...
                    case 7: return [2 /*return*/, { success: true, data: [] }];
                }
            });
        });
    };
