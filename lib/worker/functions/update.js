            ...
            try {
                ...
                switch (dataModel.getType()) {
                    case 'Sequelize': {
                        ...
                        this.cwire
                            .getLogger()
                            .system(UPDATE_ENTITIES_LOGGER_PREFIX, `Update entities by sequelize ${JSON.stringify(entity)}`);
                    ...
                    case 'Mongoose': {
                        ...
                        this.cwire
                            .getLogger()
                            .system(UPDATE_ENTITIES_LOGGER_PREFIX, `Update entities by mongoose ${JSON.stringify(entity)}`);
                        return {
                            success: true,
